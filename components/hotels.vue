<template>
  <div>
    ...
    >
      <img
        src="hotels.jpg" alt="رزرو هتل ، رزور هفت های خارجی ، رزرو هتل های داهلی ، بدرقه پرواز آرین ، کمپانی بدرقه پرواز آرین"
    ...
    >
      <a href="#" class="text-white mr-6 font-bold"> هتل ها</a>
      <a
        href="#"
