  ...
  <div>
    ...
    >
      <div class="mt-2 mb-2">
        <NuxtLink to="/">
          <img
            class="inline-block w-14 h-14 rounded-full lg:ml-10 object-cover"
            src="logo.png"
            alt="شرکت بدرقه پرواز آرین ، بدرقه پرواز آرین ، کمپانی بدرقه پرواز آرین ، بدرقه پرواز ارین ، ارائه دهنده خدمات رزرو و تور های خارجی و داخلی"
          />
        </NuxtLink>
      </div>

      <div class="md:flex lg:flex hidden pr-6">
        <NuxtLink
          to="/"
          class="mx-4 my-4 text-sm hover:text-black text-white font-bold"
        >
          <svg
        ...
        <NuxtLink
          to="/firstpagetours"
          class="text-sm hover:text-black text-white font-bold mx-4 my-4"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
